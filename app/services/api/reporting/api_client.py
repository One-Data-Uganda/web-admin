...
from app.services.api.reporting.api.general_api import AsyncGeneralApi, SyncGeneralApi
from app.services.api.reporting.api.mo_api import AsyncMoApi, SyncMoApi
from app.services.api.reporting.api.mt_api import AsyncMtApi, SyncMtApi
from app.services.api.reporting.api.statement_api import AsyncStatementApi, SyncStatementApi
from app.services.api.reporting.exceptions import ResponseHandlingException, UnexpectedResponse
...
class AsyncApis(Generic[ClientT]):
    def __init__(self, client: ClientT):
        ...
        self.general_api = AsyncGeneralApi(self.client)
        self.mo_api = AsyncMoApi(self.client)
        self.mt_api = AsyncMtApi(self.client)
        self.statement_api = AsyncStatementApi(self.client)
...
class SyncApis(Generic[ClientT]):
    def __init__(self, client: ClientT):
        ...
        self.general_api = SyncGeneralApi(self.client)
        self.mo_api = SyncMoApi(self.client)
        self.mt_api = SyncMtApi(self.client)
        self.statement_api = SyncStatementApi(self.client)

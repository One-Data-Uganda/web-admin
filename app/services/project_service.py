...
async def get_data(id):
    try:
        r = await api.project_api.get_project_data(id)
        return r
    except UnexpectedResponse as e:
        x = json.loads(e.content)
        return FailureResponseModel(success=False, message=x["message"])
...
async def get_team(id):
    try:
        r = await api.project_api.get_project_team(id)
        return r
    except UnexpectedResponse as e:
        x = json.loads(e.content)
        return FailureResponseModel(success=False, message=x["message"])
...
async def get_market(id):
    try:
        r = await api.project_api.get_project_market(id)
        return r
    except UnexpectedResponse as e:
        x = json.loads(e.content)
        return FailureResponseModel(success=False, message=x["message"])
...
async def get_investment(id):
    try:
        r = await api.project_api.get_project_investment(id)
        return r
    except UnexpectedResponse as e:
        x = json.loads(e.content)
        return FailureResponseModel(success=False, message=x["message"])
